...
class EreignisController extends AppController
{
    ...
    public function add()
    {
        ...
        $projekt = $this->Ereignis->Projekt->find('list', ['limit' => 200]);
        $angestellter = $this->Ereignis->Angestellter->find('list', ['limit' => 200]);
        $this->set(compact('ereigni', 'projekt', 'angestellter'));
    }
