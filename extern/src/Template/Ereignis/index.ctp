            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?= $this->Html->link(
                        ...
                        )).'Termine', '/ereignis', array('class' => 'nav-link active', 'escape' => false)) ?>
                </li>
            </ul>
        </div>
    </div>
...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html">Ereignisse</a>
            <!-- Form -->
            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <h3 class="mb-0">Alle anstehenden Events (muss noch userspezifisch werden!)</h3>
                    </div>
