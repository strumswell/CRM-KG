...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Angestellter Projekt'), ['action' => 'edit', $angestellterProjekt->angestellter_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Angestellter Projekt'), ['action' => 'delete', $angestellterProjekt->angestellter_id], ['confirm' => __('Are you sure you want to delete # {0}?', $angestellterProjekt->angestellter_id)]) ?> </li>
...
<div class="angestellterProjekt view large-9 medium-8 columns content">
    <h3><?= h($angestellterProjekt->angestellter_id) ?></h3>
