            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?= $this->Html->link(
                        ...
                        )).__('Termine'), '/termin', array('class' => 'nav-link active', 'escape' => false)) ?>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="col">
                <div class="card shadow">
                    <div class="card-header border-0">
                        <h2 class="mb-0"><?php echo __('Alle anstehenden Tasks')?></h2>
                    </div>
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col"><?php echo __('Kontakt')?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php foreach ($termin as $item): ?>
                                <?php foreach ($item->_matchingData as $item2): ?>
                                    <tr>
                                        ...
                                        <td>
                                        <?php
                                        foreach ($angestelltertermin as $item3) {
                                            if ($item3['termin_id'] == $item->termin_id) {
                                                echo '<div class="avatar-group">';
                                                    print('<a href="angestellter/view/'.$item3['angestellter_id'].'" class="avatar avatar-sm" data-toggle="tooltip" data-original-title="'.$item3['vorname'] .' ' . $item3['nachname'].'">');
                                                    print('<img alt="Image placeholder" src="./img/profilbilder/'.$item3['username'].'.jpg" class="rounded-circle">');
                                                    print('</a>');
