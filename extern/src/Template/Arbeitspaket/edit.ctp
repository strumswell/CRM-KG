<?php
$this->assign('title', 'Arbeitspaket bearbeiten');
        ...
        <div class="row mt-5">
            <div class="col">
                <div class="card bg-secondary shadow">
                    <?php echo $this->Form->create($arbeitspaket); ?>
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <button id="singlebutton" name="singlebutton" onclick="func()"
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-username"><?php echo __('Arbeitspaket') ?></label>
                                        <?php echo $this->Form->control('name', ['type' => 'text', 'id' => 'input-name', 'placeholder' => 'Arbeitspaket', 'value' => $arbeitspaket->name, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('beschreibung', ['type' => 'text', 'id' => 'input-beschreibung', 'placeholder' => 'Beschreibung', 'value' => $arbeitspaket->beschreibung, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-email"><?php echo __('Zuständiger') ?></label>
                                ...
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-email"><?php echo __('Kosten') ?></label>
                                        <?php echo $this->Form->control('kosten', ['type' => 'number', 'id' => 'input-kosten', 'placeholder' => 'Kosten', 'value' => $arbeitspaket->kosten, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-email"><?php echo __('Fortschritt')?></label>
                                        <?php echo $this->Form->control('fortschritt', ['type' => 'number', 'id' => 'input-fortschritt', 'placeholder' => 'Fortschritt', 'value' => $arbeitspaket->fortschritt, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email"><?php echo __('Frist') ?></label>
                                        <div class="input-group input-group-alternative">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="ni ni-calendar-grid-58"></i></span>
                                            </div>
                                            <?php echo $this->Form->control('frist', ['type' => 'text', 'id' => 'input-frist', 'placeholder' => 'Frist', 'value' => $arbeitspaket->frist, 'class' => 'form-control', 'div' => false, 'label' => false]); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="http://fbwframework.th-brandenburg.de/~bolte/cakephp/extern/vendor/nouislider/distribute/nouislider.min.js"></script>
