...
class ErreichbarkeitController extends AppController
{
    ...
    {
        $this->paginate = [
            'contain' => ['Erreichbarkeit', 'Angestellter']
        ];
    ...
    public function add()
    {
        ...
        $erreichbarkeit = $this->Erreichbarkeit->Erreichbarkeit->find('list', ['limit' => 200]);
        $angestellter = $this->Erreichbarkeit->Angestellter->find('list', ['limit' => 200]);
        $this->set(compact('erreichbarkeit', 'erreichbarkeit', 'angestellter'));
    }
