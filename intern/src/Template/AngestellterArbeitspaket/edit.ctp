...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $angestellterArbeitspaket->angestellter_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $angestellterArbeitspaket->angestellter_id)]
            )
        ?></li>
...
<div class="angestellterArbeitspaket form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Angestellter Arbeitspaket') ?></legend>
        <?php
        ?>
    </fieldset>
