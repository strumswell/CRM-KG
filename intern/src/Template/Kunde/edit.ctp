                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo __('Kunden bearbeiten') ?></h3>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('username', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'placeholder', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                                <!-- Passwort-->
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('name', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'placeholder', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                            </div>
                            <!-- Postleitzahl-->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('plz', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'placeholder', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                                <!-- Ort-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('ort', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'placeholder', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                            </div>
                            <!-- Straße-->
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('hausnummer', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'placeholder', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                            </div>
                            <!-- Telefon-->
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('registriert_am', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'placeholder', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false, 'disabled']); ?>
                                    </div>
                                </div>
                            </div>
                    </div>
