                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo __('Kunden')?></h3>
                            </div>
                            <div class="col-4 text-right">
                                <button class="btn btn-sm btn-primary" type="button" onclick="location.href='./kunde/add'">
                                ...
                                <tr>
                                    <td>
                                        <div class="avatar-group">
                                            <?php
                                            print('<a href="kunde/edit/'.$kunde->kunde_id.'" class="avatar avatar-sm" data-toggle="tooltip" data-original-title="'.$kunde->name.'">');
                                            print('<img alt="Image placeholder" src="/~bolte/cakephp/extern/webroot/img/profilbilder/'.$kunde->username.'.jpg" class="rounded-circle">');
                                            print('</a>');
                                            ?>
                                        </div>
                                    </td>
                                    ...
                                    <td><?= h($kunde->plz) ?></td>
                                    <td><?= h($kunde->ort) ?></td>
                                    <td><?= h($kunde->straße) ?> <?= $this->Number->format($kunde->hausnummer) ?></td>
                                    <td><?= h($kunde->email) ?></td>
                                    ...
                                    <td class="actions">
                                        <?= $this->Html->link($this->Html->tag('i', '', array(
                                            ...
                                            ).__(''), ['action' => 'edit', $kunde->kunde_id], array('escape' => false)) ?>
                                        <?= $this->Form->postLink($this->Html->tag('i', '', array(
                                                    'class' => 'fas fa-trash'
                                                )
                                            ).__(''), ['action' => 'delete', $kunde->kunde_id], array('escape' => false)) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
