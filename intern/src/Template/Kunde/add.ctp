            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?= $this->Html->link(
                        ...
                        )).__('Kundenverwaltung'), '/kunde', array('class' => 'nav-link active', 'escape' => false)) ?>
                </li>
                <li class="nav-item">
                    <?= $this->Html->link(
                        $this->Html->tag('i', '', array(
...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html"><?php echo __('Kunden') ?></a>
            <!-- User -->
                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo __('Kunden anlegen')?></h3>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('username', ['type'=>'text', 'id'=>'textinput',         'placeholder'=>'Username', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <!-- Passwort-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('password', ['type'=>'password', 'id'=>'textinput', 'placeholder'=>'Passwort', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                            <!-- Name-->
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('name', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'Name', 'class'=>'form-control form-control-alternative ', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="textinput">PLZ</label>
                                        <?php echo $this->Form->control('plz', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'Nachname', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <!-- Ort-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('ort', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'Ort', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('straße', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'Straße', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <!-- Hausnummer-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('hausnummer', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'Hausnummer', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('email', ['type'=>'email', 'id'=>'textinput', 'placeholder'=>'E-Mail', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <!-- Telefon-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('telefon', ['telefon'=>'text', 'id'=>'textinput', 'placeholder'=>'Telefon', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                    </div>
