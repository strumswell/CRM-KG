                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('name', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'', 'class'=>'form-control form-control-alternative ', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('plz', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <!-- Ort-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('ort', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('straße', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <!-- Hausnummer-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('hausnummer', ['type'=>'text', 'id'=>'textinput', 'placeholder'=>'', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('telefon', ['telefon'=>'text', 'id'=>'textinput', 'placeholder'=>'', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                    </div>
