                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo __('Alle offenen Projekte')?></h3>
                            </div>
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                ...
                                <th scope="col"><?php echo __('Beginn')?></th>
                                <th scope="col" class="actions"><?= __('Actions') ?></th>
                            </tr>
                            </thead>
                            <tbody class="text-center">
                            <?php foreach ($openProjekt as $item): ?>
                                    <tr>
                                        <td>
                                            <div class="avatar-group">
                                                <?php
                                                foreach ($kunden as $zustaendig) {
                                                    if ($item->kunde_id == $zustaendig['kunde_id']) {
                                                        print('<a href="kunde/edit/'.$item->kunde_id.'" class="avatar avatar-sm" data-toggle="tooltip" data-original-title="'.$zustaendig['name'].'">');
                                        ...
                                        <td class="actions">
                                            <?= $this->Html->link($this->Html->tag('i', '', array(
                                                ...
                                                ).__(''), ['action' => 'finish', $item->projekt_id], array('escape' => false)) ?>
                                            <?= $this->Html->link($this->Html->tag('i', '', array(
                                                        'class' => 'fas fa-edit'
                                                    )
                                                ).__(''), ['action' => 'edit', $item->projekt_id], array('escape' => false)) ?>

                                            <!-- <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $item->projekt_id], ['confirm' => __('Are you sure you want to delete # {0}?', $item->angestellter_id)]) ?> -->
                                        </td>
