<?php
$this->assign('title', 'Projekt bearbeiten');
                        ...
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-projektname"><?php echo __('Projekt') ?></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-first-name"><?php echo __('Hinzugefügt am') ?></label>
                                        <?php echo $this->Form->control('hinzugefuegt_am', ['type' => 'text', 'id' => 'input-hinzugefuegt_am', 'placeholder' => 'Beschreibung', 'value' => $projekt->hinzugefuegt_am, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false, 'disabled']); ?>
                                    </div>
                                </div>
                    </div>
                    <?= $this->Form->end() ?>
