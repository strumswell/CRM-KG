<?php
$this->assign('title', 'Arbeitspaket');
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?= $this->Html->link(
                        ...
                        )).'Terminverwaltung', '/termin', array('class' => 'nav-link active', 'escape' => false)) ?>
                </li>
                <li class="nav-item">
                    <?= $this->Html->link(
                        $this->Html->tag('i', '', array(
                                            ...
                                            foreach ($angestellterTermin as $item2) {
                                                foreach ($zustaendige as $zustaendig) {
                                                    if ($item2['angestellter_id'] == $zustaendig['angestellter_id'] && $item->termin_id == $item2['termin_id']) {
                                                        print('<a href="angestellter/view/'.$item2['angestellter_id'].'" class="avatar avatar-sm" data-toggle="tooltip" data-original-title="'.$zustaendig['vorname'] .' ' . $zustaendig['nachname'].'">');
