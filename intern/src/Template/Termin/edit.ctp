...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#"><?php echo __('Termine') ?></a>
            <!-- User -->
        ...
        <div class="row">
            <div class="col">
                <div class="card bg-secondary shadow">
                    <?php echo $this->Form->create($termin); ?>
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo __('Termin bearbeiten') ?></h3>
                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-username"><?php echo __('Art') ?></label>
                                        <?php echo $this->Form->control('art', ['type' => 'text', 'id' => 'input-art', 'placeholder' => 'Art', 'value' => $termin->art, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-first-name"><?php echo __('Bezeichnung') ?></label>
                                        <?php echo $this->Form->control('bezeichnung', ['type' => 'text', 'id' => 'input-bezeichnung', 'placeholder' => 'Bezeichnung', 'value' => $termin->bezeichnung, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('zustaendiger', ['options' => $users, 'value' => $ange, 'id' => 'input-zustaendiger', 'placeholder' => 'Zuständiger', 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-email"><?php echo __('Projekt') ?></label>
                                        <?php echo $this->Form->control('projekt_id', ['options' => $projekt, 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]);?>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label"
                                               for="input-email"><?php echo __('Datum') ?></label>
                                        <?php echo $this->Form->control('datum', ['class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]);?>
                                    </div>
                                </div>
                            </div>
                        </div>
