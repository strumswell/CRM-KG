                ...
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo __('Termin erstellen') ?></h3>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('zustaendiger', ['options' => $users, 'id' => 'input-zustaendiger', 'placeholder' => 'Zuständiger', 'class' => 'form-control form-control-alternative', 'div' => false, 'label' => false]); ?>
