...
<div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
            <!-- Brand -->
            <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./index.html"><?php echo __('Mitarbeiter') ?></a>
            <!-- User -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="textinput">Username (nur Kleinbuchstaben)</label>
                                    <?php echo $this->Form->control('username', ['pattern' => '([a-z])*', 'type' => 'text', 'placeholder' => 'Username', 'id' => 'textinput', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                </div>
                            </div>
                            <!-- Passwort-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->control('password', ['type' => 'password', 'placeholder' => 'Passwort', 'id' => 'textinput', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                </div>
                            </div>
                        </div>
                        <!-- Nachname-->
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->control('nachname', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'Nachname', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                </div>
                            </div>
                            <!-- Vorname-->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->control('vorname', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'Vorname', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                </div>
                            </div>
                        </div>
                        <!-- Position-->
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->control('position', ['type' => 'text', 'id' => 'textinput', 'placeholder' => 'Position', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                </div>
                            </div>
                            <!-- E-Mail-->
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <?php echo $this->Form->control('telefon', ['pattern' => '([0-9 +/]*)', 'type' => 'text', 'id' => 'textinput', 'placeholder' => 'Telefon', 'class' => 'form-control form-control-alternative ', 'div' => false, 'label' => false]); ?>
                                </div>
                            </div>
                        </div>
                    </div>
