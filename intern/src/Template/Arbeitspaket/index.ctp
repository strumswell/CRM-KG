                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo __('Alle offenen Arbeitspakete')?></h3>
                            </div>
                            <div class="col-4 text-right">
                                <button class="btn btn-sm btn-primary" type="button" onclick="location.href='./arbeitspaket/add'">
                                    ...
                                    <tr>
                                            ...
                                            <div class="avatar-group">
                                                ...
                                                foreach ($zustaendige as $zustaendig) {
                                                    if ($item2->zustaendiger == $zustaendig['angestellter_id']) {
                                                        print('<a href="angestellter/edit/'.$item2->zustaendiger.'" class="avatar avatar-sm" data-toggle="tooltip" data-original-title="'.$zustaendig['vorname'] .' ' . $zustaendig['nachname'].'">');
                                        ...
                                        <td class="actions">
                                            ...
                                            <?= $this->Html->link($this->Html->tag('i', '', array(
                                                ...
                                                ).__(''), ['action' => 'edit', $item2->arbeitspaket_id], array('escape' => false)) ?>
                                            <?= $this->Form->postLink($this->Html->tag('i', '', array(
                                                        'class' => 'fas fa-trash'
                                                    )
                                                ).__(''), ['action' => 'delete', $item2->arbeitspaket_id], array('escape' => false)) ?>

                                            <!-- <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $item2->arbeitspaket_id], ['confirm' => __('Are you sure you want to delete # {0}?', $item2->angestellter_id)]) ?> -->
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php endforeach; ?>
