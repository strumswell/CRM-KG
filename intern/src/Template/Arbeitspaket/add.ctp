                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-username"><?php echo __('Arbeitspaket')?></label>
                                        <?php echo $this->Form->control('name', ['type'=>'text', 'id'=>'input-name', 'placeholder'=>'Arbeitspaket', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-first-name"><?php echo __('Beschreibung')?></label>
                                        <?php echo $this->Form->control('beschreibung', ['type'=>'text', 'id'=>'input-beschreibung', 'placeholder'=>'Beschreibung', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <?php echo $this->Form->control('zustaendiger', ['id'=>'input-zustaendiger', 'placeholder'=>'Zuständiger', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false, 'options' => $users]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email"><?php echo __('Projekt')?></label>
                                        <?php echo $this->Form->control('projekt_id', ['id'=>'input-projekt', 'placeholder'=>'Projekt', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false, 'options' => $projekte]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label class="form-control-label" for="input-email"><?php echo __('Kosten')?></label>
                                        <?php echo $this->Form->control('kosten', ['type'=>'number', 'id'=>'input-kosten', 'placeholder'=>'Kosten', 'class'=>'form-control form-control-alternative', 'div'=>false, 'label'=>false]); ?>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
