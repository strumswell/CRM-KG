...
class BenutzerFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'benutzer_ibfk_1' => ['type' => 'foreign', 'columns' => ['PNr'], 'references' => ['angestellter', 'PNr'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'benutzer_ibfk_2' => ['type' => 'foreign', 'columns' => ['KDNr'], 'references' => ['kunde', 'KDNr'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
